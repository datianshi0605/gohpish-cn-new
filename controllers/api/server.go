...
func (as *Server) registerRoutes() {
	...
	router.HandleFunc("/campaigns/{id:[0-9]+}/auto-groups", as.CampaignAutoGroups).Methods("GET", "POST")
	router.HandleFunc("/campaigns/{id:[0-9]+}/long-term", as.CampaignLongTerm).Methods("POST")
	router.HandleFunc("/campaigns/{id:[0-9]+}/recipients", as.CampaignAppendRecipients).Methods("POST")
