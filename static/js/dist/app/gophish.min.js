...
(function(){if(!window.jQuery||!jQuery.fn.dataTable){return}jQuery.extend(true,jQuery.fn.dataTable.defaults,{language:{emptyTable:"暂无数据",zeroRecords:"没有找到匹配记录",info:"显示第 _START_ 到 _END_ 条，共 _TOTAL_ 条",infoEmpty:"显示第 0 到 0 条，共 0 条",infoFiltered:"（从 _MAX_ 条记录中过滤）",lengthMenu:"每页显示 _MENU_ 条",loadingRecords:"正在加载...",processing:"处理中...",search:"搜索：",paginate:{first:"首页",last:"末页",next:"下一页",previous:"上一页"}},oLanguage:{sEmptyTable:"暂无数据",sZeroRecords:"没有找到匹配记录",sInfo:"显示第 _START_ 到 _END_ 条，共 _TOTAL_ 条",sInfoEmpty:"显示第 0 到 0 条，共 0 条",sInfoFiltered:"（从 _MAX_ 条记录中过滤）",sLengthMenu:"每页显示 _MENU_ 条",sLoadingRecords:"正在加载...",sProcessing:"处理中...",sSearch:"搜索：",oPaginate:{sFirst:"首页",sLast:"末页",sNext:"下一页",sPrevious:"上一页"}}})})();
