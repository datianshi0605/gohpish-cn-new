var TEMPLATE_TAGS = [{
    ...
    },
    {
        id: 10,
        name: 'QRCodeURL',
        description: 'The recipient-specific QR code image URL.'
    },
    {
        id: 11,
        name: 'QRCode',
        description: 'An HTML image tag for the recipient-specific QR code.'
    },
    {
        id: 12,
        name: 'QRCodeHTML',
        description: 'An inline HTML QR code that does not depend on remote images.'
    }
];
